...
function updateCurrentImage(slideI = 0) {
...
function displayImages(slideI) {
    ...
    legend.textContent = slidesData[slideI].description //verif slideIndex?
...
function init() {
    ...
    legend.textContent = slidesData[slideIndex].description // verif
    imgs.forEach((img, indexImg) => {
